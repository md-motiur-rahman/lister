...
export default function SignIn() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-primary" edges={["top"]}>
      <View className="absolute -left-16 top-12 h-56 w-56 rounded-full bg-background/20 dark:bg-background/40" />
      <View className="absolute right-[-74px] top-40 h-72 w-72 rounded-full bg-background/15 dark:bg-background/35" />
      <View className="px-6 pt-4">
        ...
        <View className="mt-6 rounded-[30px] border border-white/20 bg-white/5 p-3">
          <Image
            source={require("@/assets/images/lister.png")}
      ...
      <View className="mt-8 flex-1 rounded-t-[36px] bg-card px-6 pb-8 pt-6">
        ...
        <Text className="mt-2 text-center text-sm leading-6 text-primary dark:text-yellow-50">
